namespace ScreenCam
{
	partial class Editor
	{
		...
		private void InitializeComponent()
		{
			...
			this.frameCount.Text = "Frame: i/n";
			// 
			// removeFrame
			// 
			...
			this.removeFrame.Text = "Remove frame";
			...
			this.removeThisToEnd.Text = "Remove from this to end";
			...
			this.removeStartToThis.Text = "Remove from start to this";
